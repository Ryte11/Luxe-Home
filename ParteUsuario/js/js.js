...
function cambiar_productos() {
  ...
  function filtrarPropiedades() {
    ...
    tarjetas.forEach(tarjeta => {
      // Obtener el atributo data-tipo que contiene "categoria-operacion"
      let dataTipo = tarjeta.getAttribute("data-tipo").toLowerCase();
      let [categoria, tarjetaOperacion] = dataTipo.split('-');
      
      // Verificar si la tarjeta debe mostrarse según los filtros
      ...
      console.log(`Comparando: ${categoria} == ${tipoFiltrado} && ${tarjetaOperacion} == ${operacionFiltrada}`);
      console.log(`Resultado: ${mostrarPorTipo} && ${mostrarPorOperacion}`);
